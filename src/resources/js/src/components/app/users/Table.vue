<template>
    <div>
        <div class="panel pb-0 mt-6">
            <h5 class="font-semibold text-lg dark:text-white-light mb-5">Users</h5>
            <div class="flex justify-between mb-4">    
                <input v-model="params.search" type="text" class="form-input max-w-xs" placeholder="Search..." />
                <button type="button" class="btn btn-info" @click="showPopup = true">Add</button>
            </div>
            <div class="datatable">
                <vue3-datatable
...
<script setup>
    ...
    const cols =
        ref([
            ...
            { field: 'status', title: 'status', headerClass: '!text-center flex justify-center', width: 'full' },
