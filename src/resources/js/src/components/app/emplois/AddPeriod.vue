                                ...
                                <div class="p-5">
                                    <form>
                                        ...
                                        <div class="relative mb-4">
                                            ...
                                            <input type="text" class="form-input" :value="groupName" disabled />
                                        </div>

                                        <!-- TYPE (READ ONLY) -->
                                        <div class="relative mb-4">
                                            <label class="text-sm">Type :</label>
                                            <input type="text" class="form-input" value="Période" disabled />
                                        </div>
                                        ...
                                        <div class="relative mb-4">
                                            ...
                                            <div class="flex justify-between gap-3 mt-2">
                                                <input v-model="data.from" type="date" class="form-input w-[48%]" />
                                                <input v-model="data.to" type="date" class="form-input w-[48%]" />
                                            </div>
...
const data = ref({
    ...
    data.value.group_id = props.group_id
    data.value.salle = props.salle
  })
...
const attachTiming = () => {
    ...
    data.value.timing.push({
        day: data.value.day,
        dates: [`du ${data.value.from_time} a ${data.value.to_time}`],
    });
...
const detachTiming = (t) => {
    data.value.timing = data.value.timing.filter((x) => x !== t);
};
