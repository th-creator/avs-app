...
export const useRegistrantsStore = defineStore("registrants", () => {
    ...
    const store = async (payload) => {
        ...
        registrants.value.push({
            ...
            fullName: response.data.data.student.firstName+' '+response.data.data.student.lastName,
