...
<script setup>
    ...
    import ExpansesTable from '@/components/app/expanses/Table.vue';
    import TaecherExpansesTable from '@/components/app/teacherExpanses/Table.vue';
</script>