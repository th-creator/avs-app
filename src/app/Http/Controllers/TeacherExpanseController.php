...
{   
    ...
    public function all($month, $year)
    {
        ...
        * ================================ */
        ...
        foreach ($data as $expanse) {

            // Fetch payments ONLY for this paid group
            $group = Group::where('intitule',$expanse->group)->first();
            $missingPayments = [];
            $missingPayments = Payment::whereHas('registrant', function ($query) use ($currentDate) {
            ...
            $expanse->missing_students = $missingPayments;
        }
